...
<div className="min-w-screen min-h-screen bg-slate-950 flex items-center justify-center py-5">
    <div className="w-[95%] bg-slate-950 border-t border-b border-gray-500 px-5 py-16 md:py-24 text-white">
        <div className="w-full max-w-6xl mx-auto">
            <div className="text-center max-w-xl mx-auto">
                <h1 className="text-6xl md:text-7xl font-bold mb-5 text-gray-200">What people <br/>are saying.</h1>
                <h3 className="text-xl mb-5 font-light">Client Satisfaction is our First Priority</h3>
            ...
            <div className="-mx-3 md:flex items-start">
                <div className="px-3 md:w-1/3">
                    <div className="w-full mx-auto rounded-lg bg-blue-600  p-5 text-gray-100 font-light mb-6">
                        <div className="w-full flex mb-4 items-center">
                            <div className="overflow-hidden rounded-full w-10 h-10 bg-gray-400 ">
                                <img src="https://i.pravatar.cc/100?img=1" alt=""/>
                            </div>
                            <div className="flex-grow pl-3">
                                <h6 className="font-bold text-sm uppercase text-gray-100">Kenzie Edgar.</h6>
                            </div>
                        </div>
                    ...
                    <div className="w-full mx-auto rounded-lg bg-blue-600  p-5 text-gray-100 font-light mb-6">
                        <div className="w-full flex mb-4 items-center">
                            ...
                            <div className="flex-grow pl-3">
                                <h6 className="font-bold text-sm uppercase text-gray-100">Stevie Tifft.</h6>
                            </div>
                        </div>
                        <div className="w-full">
                ...
                <div className="px-3 md:w-1/3">
                    <div className="w-full mx-auto rounded-lg bg-blue-600  p-5 text-gray-100 font-light mb-6">
                        <div className="w-full flex mb-4 items-center">
                            ...
                            <div className="flex-grow pl-3">
                                <h6 className="font-bold text-sm uppercase text-gray-100">Tommie Ewart.</h6>
                            </div>
                        </div>
                        <div className="w-full">
                    ...
                    <div className="w-full mx-auto rounded-lg bg-blue-600  p-5 text-gray-100 font-light mb-6">
                        <div className="w-full flex mb-4 items-center">
                            ...
                            <div className="flex-grow pl-3">
                                <h6 className="font-bold text-sm uppercase text-gray-100">Charlie Howse.</h6>
                            </div>
                        </div>
                        <div className="w-full">
                ...
                <div className="px-3 md:w-1/3">
                    <div className="w-full mx-auto rounded-lg bg-blue-600  p-5 text-gray-100 font-light mb-6">
                        <div className="w-full flex mb-4 items-center">
                            ...
                            <div className="flex-grow pl-3">
                                <h6 className="font-bold text-sm uppercase text-gray-100">Nevada Herbertson.</h6>
                            </div>
                        </div>
                        <div className="w-full">
                    ...
                    <div className="w-full mx-auto rounded-lg bg-blue-600  p-5 text-gray-100 font-light mb-6">
                        <div className="w-full flex mb-4 items-center">
                            ...
                            <div className="flex-grow pl-3">
                                <h6 className="font-bold text-sm uppercase text-gray-100">Kris Stanton.</h6>
                            </div>
                        </div>
                        <div className="w-full">
